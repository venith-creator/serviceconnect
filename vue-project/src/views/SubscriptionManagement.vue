          ...
          <div class="mt-6 flex justify-end space-x-3">
            ...
            <button
              ...
              :class="[
                ...
                canAddService ? 'bg-purple-600 hover:bg-purple-700' : 'bg-purple-300 cursor-not-allowed',
      ...
      <template v-else>
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button
              ...
              class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-purple-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
